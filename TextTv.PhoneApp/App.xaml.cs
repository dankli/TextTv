...
namespace TextTv.PhoneApp
{
    ...
    public sealed partial class App : Application
    {
        ...
        private async void OnSuspending(object sender, SuspendingEventArgs e)
        {
            ...
            SyncPages syncPages = await new SyncPages(null, new SyncPagesIO()).Initialize();
            if (await syncPages.Any() == false)
            {
                NotifierTaskHandler notifierTaskHandler = new NotifierTaskHandler();
                notifierTaskHandler.UnRegisterTask();
            }
